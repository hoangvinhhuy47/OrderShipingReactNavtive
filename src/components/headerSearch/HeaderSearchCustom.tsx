    ...
    <View style={styles.view}>
      <View style={styles.headertabview}>
        ...
        <View style={[styles.headertabview_iconsearch,
          ...
          <TouchableOpacity onPressIn={onPressBarCode} style={{ height: hp(5), width: wp(12), justifyContent: 'center', alignItems: 'center' }}>
            <Image source={BarCode} style={{ aspectRatio: 1, height: hp(4), width: wp(12) }}></Image>
          </TouchableOpacity>
          <TouchableOpacity onPressIn={onPressSearch} style={{ backgroundColor: '#057DC0', height: hp(5), borderRadius: 5, width: wp(20), justifyContent: 'center', alignItems: 'center' }}>
