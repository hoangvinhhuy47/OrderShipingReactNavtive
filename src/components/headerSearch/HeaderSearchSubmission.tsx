...
interface HeaderSearchSubmission {
  onPressSubmission: any;
  onPressSearch: any;
  value?: any;
  _onChangeText?: any;
  style?: ViewStyle;
...
export const HeaderSearchSubmission = (props: HeaderSearchSubmission) => {
  const { onPressSubmission, value, onPressBarCode,style, titleStyle, onPressSearch, _onChangeText, disabaledSp, positionsp } = props
    ...
    <View style={styles.view}>
      <View style={styles.headertabview}>
        ...
        <View style={[styles.headertabview_iconsearch,
          ...
          <TouchableOpacity disabled = {disabaledSp} onPressIn={onPressSubmission} style={[{ backgroundColor: '#057DC0', height: hp(5), borderRadius: 5, width: wp(25), justifyContent: 'center', alignItems: 'center' }, positionsp]}>
            <Text style={{ fontSize: wp(3.5), color: 'white' }}>Nộp phiếu</Text>
          </TouchableOpacity>
        </View>
      </View>
