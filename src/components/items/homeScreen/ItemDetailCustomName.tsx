            ...
            <TouchableOpacity
                ...
                <View style={[styles.item, styleItem]}>
                    ...
                    <View style={styles.header2}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingRight: 8, alignItems: 'center', width:'90%'}}>
                            <Text
                                style={{
                                    fontSize: wp(4),
                                    color: 'black',
                        ...
                        {typeItem == true ? <View><Image source={sourceIcon} style={{ height: hp(3.3), width: hp(3.3), resizeMode: 'contain' }}></Image></View> : <View></View>}
                        </View>
                    </View>
                    {
                        addressCustomer?
