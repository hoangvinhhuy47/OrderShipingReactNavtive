            ...
            {Status == true ? 
                <View style={styles.bottom}>
                    ...
                    {Option == '1' ? <IconDetailCustom
                        ...
                        labelStyle={{ color: mainColors.greenscolor, fontSize: wp(2.9) }}
                        title={'Nhận phiếu'}
                        sourceICon={Check}
                        style={styles.ButtonBottom}
