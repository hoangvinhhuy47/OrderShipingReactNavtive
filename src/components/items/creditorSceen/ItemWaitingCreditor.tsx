...
export const ItemWaitingCreditor = (props: ItemWaitingCreditor) => {
    const [showIcon, setShowIcon] = useState(false)
    const { PhoneNumBer,Status, customerCode, titleAcpect, onPressDetail, index, onPressApply, Reload, SaleVoiceID, styleItem, navigation, onPressItem, codeOrder, dateTime, nameCustomer, addressCustomer, noteOder, sourceIcon, typeItem } = props
