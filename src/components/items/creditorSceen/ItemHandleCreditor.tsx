...
export const ItemHandleCreditor = (props: ItemHandleCreditor) => {
    const [showIcon, setShowIcon] = useState(false)
    const { PhoneNumBer,Status, customerCode, titleAcpect,onPressPayVotes, onPressDetail, index, Reload, SaleVoiceID, styleItem, navigation, onPressItem, codeOrder, dateTime, nameCustomer, addressCustomer, noteOder, sourceIcon, typeItem } = props
