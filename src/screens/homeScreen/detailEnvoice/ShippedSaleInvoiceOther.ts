...
import { ShippedSaleInvoiceOther } from '../../../services/homeScreen/Detail/ShippedSaleInvoiceOther';
import { ToastAndroid } from 'react-native';

export const shippedSaleInvoiceOthere = (props: any) => {
  ...
  const onPressAccept = async (ID: string) => {
    let dataResult = await ShippedSaleInvoiceOther(profileInfo.UserID, ID);
    if (dataResult != null) {
