...
import { GetDataFinishDetail } from './GetDataFinishDetail';
import { DeleteSubmita } from './DeleteSubmit';
...
const FinishDetail = (props: any) => {
  ...
  const { data, onPressSearch, setData } = GetDataFinishDetail(props);
  const { onPressDeleteSubmit, ErrorDescription } = DeleteSubmita(props);
