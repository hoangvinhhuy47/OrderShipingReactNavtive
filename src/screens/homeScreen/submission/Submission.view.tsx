...
import { ItemSubmisstionCustom } from '../../../components/items/homeScreen/ItemSubmisstionCustom';
...
const Submission = (props: any) => {
  ...
  const {
    ...
    pageIndex,
    setPageIndex,
  } = getDataSubmisstion(props);
  const { onPressSubmiss } = AcceptSaleInvoice(props);
