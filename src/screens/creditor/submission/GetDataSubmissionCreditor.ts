...
import { GetSaleInvoiceCreditorWaitingSubmit } from '../../../services/CreditorScreen/submissionCreditor/GetSaleInvoiceCreditorWaitingSubmit';
import { SaleInvoiceClient } from '../../../components/object/Order';
import lodash from 'lodash'

export const GetDataSubmissionCreditor = (props: any) => {
  ...
  const onPressSearch = async () => {
    if (Check == true) {
      let dataGetSaleInvoiceNoteReceive = await GetSaleInvoiceCreditorWaitingSubmit(profileInfo.UserID, pageIndex, searchString);
