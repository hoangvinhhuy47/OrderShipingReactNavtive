...
import { GetSaleInvoiceCreditorWaitingReceive } from './GetSaleInvoiceCreditorWaitingReceive';
...
const WaitingCreditor = (props: any) => {
  const {
    TotalRow,
    handleLoadMore,
    search,
    ...
    pageIndex,
    setPageIndex,
  } = GetSaleInvoiceCreditorWaitingReceive(props);
  ...
  const onScanBarCode = () => {
    props.navigation.navigate('CreditorWaitingReceiveOther', {BarCodee: 'Nhập số chứng từ...'});
  };
    ...
    return (
      <View>
        <ItemWaitingCreditor
          ...
          dateTime={getDataByThing.getDayMonthYearHourStringDetail(item.AccountingDate)}
  ...
  return (
    <BackgroundDetailCreditorScreen title='1. Chờ nhận' navigation={props.navigation}>
...
export default WaitingCreditor;
