...
import { GetSaleInvoiceCreditorSubmit } from '../../../services/CreditorScreen/finishCreditor/GetSaleInvoiceCreditorSubmit';
import { SaleInvoiceClient, VoucherSubmitClient } from '../../../components/object/Order';
import lodash from 'lodash'
import { ToastAndroid } from 'react-native';


export const getDataFinishCreditor = (props: any) => {
  ...
  const onPressSearch = async () => {
    if (Check == true) {
      let dataGetSaleInvoiceNotePrinted = await GetSaleInvoiceCreditorSubmit(profileInfo.UserID, pageIndex.toString());
